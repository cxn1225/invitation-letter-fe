...
const modules = import.meta.glob('../../generated/checkin/live/**/*.checkin.ts', { eager: true }) as Record<string, { default: { slug: string; title: string; venue: string; startAt: string; enabled: boolean } }>
